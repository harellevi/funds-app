        ...
        >
          ...
          <div className="flex-1 sm:py-0 py-4">
              ...
              <div className="flex justify-start space-x-2">
                ...
                <small className="text-gray-500 font-bold">
                  {project?.backers} Backer{project?.backers == 1 ? '' : 's'}
                    ...
                    {/* סטטוס הפרויקט בהתאם לתאריך פג תוקף */}
            ...
            <div>
              ...
              {/* הקו הירוק שמראה כמה מהכסף נאסף */}
              ...
              <div className="flex justify-start items-center space-x-2 mt-4">
                {/* //אם הסטטוס הוא עדיין פתוח - שיראה את כפתןור התמיכה, אחרת לא  */}
                {project?.status == 0 ? (
                  <button
                    type="button"
              ...
              //בעת שלוחצים על הכפתור הטופס של תמיכה בפרויקט יפתח לגודל 100
                  ...
                  >
                    ...
                    {/* אם התנאים מתקיימים יהיה כפתור משיכת כסף */}
                    {/* //כפתור זה יעבוד רק למי שהוא יוצר הפרויקט */}
                {connectedAccount == project?.owner ? (
                    //הפרויקט לא מחוק
                  project?.status != 3 ? (
                    //הפרויקט מאושר (הגיעו ליד הכספי לפני שנגמר התוקף)
                    project?.status == 1 ? (
                      <button
                        type="button"
                        ...
                        //הפעת הפונקציה למשיכת הכסף של פרויקט זה 
                      ...
                      {/* כפתור לעריכת הפרויקט */}
                        <button
                          type="button"
                          className="inline-block px-6 py-2.5 bg-gray-600
                          text-white font-medium text-xs leading-tight uppercase
                          rounded-full shadow-md hover:bg-gray-700"
                          //נגדיר שבעת לחיצה על הכפתור עריכה, הטופס של עריכת פרויקט יגדל לגודל 100 ויופיע (בברירת המדל הוא בגודל 0)
                          onClick={() =>
                        ...
                        {/* כפתור למחיקת הפרויקט */}
                        <button
                          type="button"
                          className="inline-block px-6 py-2.5 bg-red-600
                          text-white font-medium text-xs leading-tight uppercase
                          rounded-full shadow-md hover:bg-red-700"
                        //בעת לחיצה על הכפתור יפתח הטופס של מחיקת הפרויקט בגודל 100
                          onClick={() =>
