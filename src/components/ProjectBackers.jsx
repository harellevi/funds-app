//בתוך דף ייחודי של פרויקט- החלק של התומכים בפרויקט למטה
...
const ProjectBackers = ({ backers }) => {
  return (
    <div className="flex flex-col justify-center items-start md:w-2/3 px-6 mx-auto">
      <div
        classNa me="max-h-[calc(100vh_-_25rem)] overflow-y-auto
        shadow-md rounded-md w-full mb-10"
      >
        {/* טבלה של התומכים */}
        {/* עמודת של תומך,סכום,האם קיבל החזר, זמן */}
        <table className="min-w-full">
          ...
          {/* הגוף של הטבלה יהיה מאוכלס ממאפינג של התומכים */}
          <tbody>
