//הטופס שנפתח בעת שלוחצים על תמיכה בפרויקט בדף של םרויקט מסוים
...
const BackProject = ({ project }) => {
  ...
  //פונקצית התמיכה בפרויקט
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!amount) return
    //נעביר לפונקציה של תמיכה בפרויקט את האיידי של הפרויקט והסכום שרוצים לתרום 
